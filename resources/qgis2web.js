...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            //extent: [121.478070, 13.945631, 121.754620, 14.101714],
            units: 'degrees'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([121.580907, 14.019559, 121.592259, 14.028036], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Tayabas–Lucban Bypass Road Inventory Web Map</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (283 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This interactive web map presents the Tayabas–Lucban Bypass Road and Corridors Road Inventory. Road segments are displayed with attributes including classification, condition, structure type, and elevation, providing a clear overview of infrastructure quality and geographic context.';
            }
