...
var lyr_RoadClassification_5 = new ol.layer.Vector({
    ...
    <img src="styles/legend/RoadClassification_5_0.png" /> National Road<br />\
    <img src="styles/legend/RoadClassification_5_1.png" /> Bypass Road<br />\
    <img src="styles/legend/RoadClassification_5_2.png" /> Provincial Road<br />\
    <img src="styles/legend/RoadClassification_5_3.png" /> Barangay Road<br />' });
...
var group_CRID = new ol.layer.Group({
                                layers: [lyr_RoadinventoryDatabase_6,],
                                fold: 'open',
                                title: 'CRID'});
var group_ThematicLayers = new ol.layer.Group({
                                layers: [lyr_Elevation_2,lyr_SurfaceType_3,lyr_RoadCondition_4,lyr_RoadClassification_5,],
                                fold: 'open',
...
lyr_GoogleSatellite_0.setVisible(true);lyr_TayabasAdministrativeMap_1.setVisible(true);lyr_Elevation_2.setVisible(true);lyr_SurfaceType_3.setVisible(true);lyr_RoadCondition_4.setVisible(true);lyr_RoadClassification_5.setVisible(true);lyr_RoadinventoryDatabase_6.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,group_TayabasCityAdmininistrativeMap,group_ThematicLayers,group_CRID];
...
lyr_Elevation_2.set('fieldLabels', {'fid': 'hidden field', 'id': 'inline label - visible with data', 'order': 'inline label - visible with data', 'Length_m': 'inline label - visible with data', 'Segment ID': 'inline label - visible with data', 'Barangay': 'inline label - visible with data', 'Road Classification': 'inline label - visible with data', 'Width_m': 'inline label - visible with data', 'Number of lanes': 'inline label - visible with data', 'Surface Type': 'inline label - visible with data', 'Number of Lanes with Asphalt': 'inline label - visible with data', 'Road Condition': 'inline label - visible with data', 'Road lines': 'header label - visible with data', 'Street lights': 'inline label - visible with data', 'Remarks': 'inline label - visible with data', 'Struc_type': 'inline label - visible with data', 'X': 'inline label - visible with data', 'Y': 'inline label - visible with data', 'Z': 'inline label - visible with data', 'Elevation_mean': 'inline label - visible with data', 'Elevation_min': 'inline label - visible with data', 'Elevation_max': 'inline label - visible with data', 'Elevation_m': 'inline label - visible with data', });
lyr_SurfaceType_3.set('fieldLabels', {'fid': 'hidden field', 'id': 'inline label - visible with data', 'order': 'inline label - visible with data', 'Length_m': 'inline label - visible with data', 'Segment ID': 'inline label - visible with data', 'Barangay': 'inline label - visible with data', 'Road Classification': 'inline label - visible with data', 'Width_m': 'inline label - visible with data', 'Number of lanes': 'inline label - visible with data', 'Surface Type': 'header label - visible with data', 'Number of Lanes with Asphalt': 'header label - visible with data', 'Road Condition': 'header label - visible with data', 'Road lines': 'inline label - visible with data', 'Street lights': 'inline label - visible with data', 'Remarks': 'inline label - visible with data', 'Struc_type': 'inline label - visible with data', 'X': 'inline label - visible with data', 'Y': 'inline label - visible with data', 'Z': 'inline label - visible with data', 'Elevation_mean': 'inline label - visible with data', 'Elevation_min': 'inline label - visible with data', 'Elevation_max': 'inline label - visible with data', 'Elevation_m': 'inline label - visible with data', });
lyr_RoadCondition_4.set('fieldLabels', {'fid': 'hidden field', 'id': 'hidden field', 'order': 'hidden field', 'Length_m': 'inline label - visible with data', 'Segment ID': 'inline label - visible with data', 'Barangay': 'inline label - visible with data', 'Road Classification': 'inline label - visible with data', 'Width_m': 'inline label - visible with data', 'Number of lanes': 'inline label - visible with data', 'Surface Type': 'inline label - visible with data', 'Number of Lanes with Asphalt': 'inline label - visible with data', 'Road Condition': 'inline label - visible with data', 'Road lines': 'inline label - visible with data', 'Street lights': 'inline label - visible with data', 'Remarks': 'inline label - visible with data', 'Struc_type': 'inline label - visible with data', 'X': 'inline label - visible with data', 'Y': 'inline label - visible with data', 'Z': 'inline label - visible with data', 'Elevation_mean': 'no label', 'Elevation_min': 'inline label - visible with data', 'Elevation_max': 'inline label - visible with data', 'Elevation_m': 'inline label - visible with data', });
